...
//   if(x>=0 && x<12/* the relation `relName` already has an entry in the Open Relation Table */)
//   {
//     return x;
...
//   x=OpenRelTable::getFreeOpenRelTableEntry();
//   /* find a free slot in the Open Relation Table
//      using OpenRelTable::getFreeOpenRelTableEntry(). */
//   if (x==E_CACHEFULL/* free slot not available */){
//     return E_CACHEFULL;
//   }
...
//   RecId relcatRecId;
  ...
  // relcatRecId=BlockAccess::linearSearch(0,array,attri,0);
...
//       Attribute attrCatRecord[ATTRCAT_NO_ATTRS];
//       RecId attrcatRecId;
//       attrcatRecId=BlockAccess::linearSearch(1,array,attri,0);
